...
public class Programa1 {
  ...
  public static void main(String []args){
    ...
    try (BufferedReader brInput = new BufferedReader(new InputStreamReader(System.in))){
      ...
      do {
        ...
        if(sFilePath.length()!=0){
          ...
          try (FileReader frFile = new FileReader(new File(sFilePath))){
            ...
            //Creo el objeto de tipo archivo con el nombre o path ingresado y le asigna el OrdenadorDeArchivo
            ldaArchivo = new LectorDeArchivo(frFile,sFilePath,odaOrdenador);//&m
      ...
      //Imprimo mi lista de partes con sus líneas de código
      odaOrdenador.printPartList();//&m
    }catch(IOException e){
